			...
			<div class='first_div'>
				...
				<div id='main_div5' class='main_divs'>
					...
					foreach($products_information as $each_product)
					{
						...
						echo "<div style='float:left; display:inline; width:100%; text-align:center; border:1px #00B2EE solid; overflow:hidden;'><label class='data_labels_bold' style='font-size:14px;'>Vendor Cost</label> <br> <input type='number' min='0' id='product_".$temp_product_ids_array[$product_id_counter]."' class='vendor_product_prices' style='width:60%;' value='".$each_product['vendor_price']."'></div>";
						echo "</div>";
						echo "</div>";
						$counter++;
						$product_id_counter++;
				...
				<div id='main_div5point1' class='main_divs'>
					...
					<div style='display:inline; float:left; width:32%; margin:0px 0px 0px 0px;'>
						<label class='data_labels_bold'>Vendor Product Total</label> : <label class='data_labels_normal'><?php echo $order_information["vendor_product_grand_total"]; ?><br>
						...
						<label class='data_labels_bold'>Total Cost</label> : <label class='data_labels_normal'><?php echo $order_information['final_vendor_price']; ?></label>
					</div>

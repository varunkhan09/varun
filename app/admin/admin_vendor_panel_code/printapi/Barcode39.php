...
/**
 * Description of Code 39 Barcode Image Generator
 *
 * @author flaberry
 */
...
final class Barcode39 {
    ...
    public function draw($filename = null) {
        ...
        if ($this->barcode_text) {
            ...
            // draw barcod text
            imagestring($img, $font_size, $pos_center, $this->barcode_height - $barcode_text_h - 2, $barcode_string, $_000);
        }
    ...
    public function loadImage($filename = null) {

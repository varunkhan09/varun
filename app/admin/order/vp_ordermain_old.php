	...
	if($_REQUEST['flag'] == "1")
	{
		...
		if(mysql_num_rows($result)>0)
		{
			...
			while($row = mysql_fetch_assoc($result))
			{
				...
				$query5 = "select miscellaneous_charges, state, deliveryboy, deliveryboy_contact from vendor_processing where orderid=$orderid limit 1";
			...
			*/
			...
			$order_information["finalprice"] = $grand_total+$order_information['servicecharges']+$order_information['deliverycharges'];
			...
			<div class='first_div'>
				<div id='main_div1' class='main_divs'>
					<div id='main_div0' class='main_div1_0'>
						...
						echo "<input type='button' id='update_vendor_price_b' value='Update Vendor Price' class='main_buttons_green1'>";
				...
				<div id='main_div5' class='main_divs'>
					...
					foreach($products_information as $each_product)
					{
						...
						//echo "<div style='float:left; display:inline; width:100%; text-align:center; border:1px #00B2EE solid; overflow:hidden;'><label class='data_labels_bold' style='font-size:14px;'>Vendor Price</label> <br> <label class='data_labels_normal'>".$each_product['vendor_price']."</label></div>";
				...
				<div id='main_div5point1' class='main_divs'>
					...
					<div style='display:inline; float:left; width:50%; margin:2px 0px 0px 0px;'>
						<label class='data_labels_bold'>Merchandise Total</label> : <label class='data_labels_normal'><?php echo $grand_total; ?><br>
						<label class='data_labels_bold'>Delivery Charges</label> : <label class='data_labels_normal'><?php echo $order_information['deliverycharges']; ?></label><br>

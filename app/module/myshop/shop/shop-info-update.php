             ...
             <!--  <br><br><br>
                ...
                <div class="col-xs-6 col-sm-4 div-center form-item">
                    <div class="panel panel-default">
                        ...
                        <!-- Edited 20/06/2015  -->
                        <form id="shop_logo" action="/app/module/myshop/shop/shop-logo-upload.php" method="post" enctype="multipart/form-data">
                          <div class="form-group" style="padding: 10px 0px 10px 0px;">
                                <label class="control-label" for="si_x" >Shop Logo</label>
                                <input id='si_x' type="file" name="uploadedimage"/>
                                <input id="shop_logo_upload" type="submit" name="submit" value="Upload" />
                                <div id='onsuccessmsg' style="color:"></div>
                          </div>
                        </form>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input readonly id="si_10" ng-model="Shop.contact_person" type="text" class="form-control" name="contact_person"/>
                                    </div>
                                 </div> 
                    ...
                    $(document).ready(function(){
                        function onsuccess(response,status){
                            if(status === 'success'){
                             ...
                             $("#onsuccessmsg").css("color", "#088A08");
                             window.location.reload();

                            }else{
                                $("#onsuccessmsg").html("Status :<b>"+status+'</b>');
                                $("#onsuccessmsg").css("color", "#FF0000");
                                window.location.reload();
                            }
                         }
                         $("#shop_logo").on('submit',function(){
                              var options={

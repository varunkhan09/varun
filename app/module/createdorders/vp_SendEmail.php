...
require($base_path_folder.'/app/etc/googleemail/class.phpmailer.php');  ////Include PHPMailer Class/////
//echo $base_path_folder.'/app/etc/googleemail/class.phpmailer.php';
	try
		{
			...
			$mail->Password   = "0151Nanotech%";            // SMTP server password
			$mail->SMTPSecure = "ssl";
...
function fetchVendorEmailFromName($vendorName)
		...
		$query = "select email from pos_shop_entity where shop_name like '%$vendorName%' limit 1";
		$result_vendors_fetchVendorEmailFromName = mysql_query($query); ////Result Set for the SQL QUERRY's Result////

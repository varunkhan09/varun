...
<body>
<center>
<label class='heading'>Cancel Order</label>
</center>
...
?>	
	<div id='main_div1' style='float:left; display:inline; width:100%; margin:10px 0px 10px 0px;'>
		<label class='heading_labels'>Are you sure you want to Cancel this order ?</label>
	</div>
	<div id='main_div2'>
...
else
{
	...
	{
		$orderid = $_REQUEST['orderid'];
		$query = "update vendor_processing set state=4 where orderid = $orderid";
		...
		if($result)
		{
			...
			<?php
			echo "<label class='heading_labels'>Order has been Cancelled.</label><br><br>";
		}
		else
		{
			echo "<label class='heading_labels'>Could not Cancel this order. Please try again.</label><br><br>";
			echo mysql_error();
		}
	}
}

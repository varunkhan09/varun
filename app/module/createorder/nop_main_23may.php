...
<form method='post' style='border:0px; margin:0px; display:inline; float:left;'>
	...
	<div style='float:left; width:100%; padding:15px 0px 0px 0px; border-bottom:3px solid #00688B;'>
				...
				<table style='width:100%; text-align:center;' id='merchandise_table' cellspacing="1">
					...
					<tr id='product_row_1' class='hoverable'>
						...
						<td class='thistd'>
							...
							<br>
							<div id='product_items_data_1' class='product_items_data_class'></div>
							<br>
							<input type="textbox" id="product_item_backtext_1" placeholder="Tags" class="tm-input" style="display:none;">

							<input type='hidden' id='product_items_tags_1' name='product_items_tags_1' value=''>
							<br>
							<input type="text" id="product_item_entry_1" data-provide="typeahead" class="product_item_entry_class">
						</td>
						<td class='thistd'>
		...
		<div id='main_div_row7' style='float:left; width:100%; padding:10px 0px 0px 0px; text-align:left; text-align:center;'>
			<input type='button' value='Submit' id='submit_b' class='thisbuttonfont buttons'>
		</div>
	</div>
...
else
{
	if($_REQUEST['flag'] == '1')
	{
		...
		*/
		...
		$query = "insert into panelorderdetails (orderid, productid, productsku, productquantity, productunitprice, productvdescription, order_source, account_type, dod, shippingtype, recipient_pincode, shop_id) values ";
		foreach($normal_product_ids as $normal_product_ids_inside_foreach)
		{
			...
			//echo "<br>";
			$query .= "(varun, ".$normal_product_ids_inside_foreach.", '".$normal_product_details_array[$normal_product_ids_inside_foreach]['sku']."', ".$normal_product_details_array[$normal_product_ids_inside_foreach]['quantity'].", '".$normal_product_details_array[$normal_product_ids_inside_foreach]['unitprice']."', '".$normal_product_details_array[$normal_product_ids_inside_foreach]['vendordescription']."', '".$order_source."', '".$sender_account_type."', '".$delivery_date."', '".$delivery_type."', '".$recipient_postal_code."', $shop_id), ";
		}
		...
		foreach($custom_product_ids as $custom_product_ids_inside_foreach)
		{
			...
			$query .= "(varun, ".$custom_product_array[$counter]['id'].", '".$custom_product_array[$counter]['sku']."', ".$custom_product_details_array[$custom_product_ids_inside_foreach]['quantity'].", '".$custom_product_details_array[$custom_product_ids_inside_foreach]['unitprice']."', '".$custom_product_details_array[$custom_product_ids_inside_foreach]['vendordescription']."', '".$order_source."', '".$sender_account_type."', '".$delivery_date."', '".$delivery_type."', '".$recipient_postal_code."', $shop_id), ";
			$counter++;
		}

...
function fetchVendorEmailFromName($vendorName)
{
	...
	global $magento_database;

	mysql_select_db($vendorshop_database);
	$query = "select email from pos_shop_entity where shop_name='$vendorName'";
...
function fetchVendorIdFromName($vendorName)
{
	...
	mysql_select_db($vendorshop_database);
	$query = "select entity_id from pos_shop_entity where shop_name='$vendorName'";
	$result = mysql_query($query);
	$row = mysql_fetch_assoc($result);
	mysql_select_db($magento_database);

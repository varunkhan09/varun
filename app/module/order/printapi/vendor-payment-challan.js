 ...
 * @param {type} rdim
 * @param {type} data
 * @param {type} brControl
 * @returns {marginConfig.yOffset}
 * 
            ...
            for (var key in obj) {
                ...
                if (key.charAt(0) !== '$') {
                    ...
                    if (((cell.length * fontSize) + xOffset) > (width)) {
                        ...
                        // quantity dtata value here 
                        this.text(x + 50, y, cell);
                        // console.log(cell);
                    }
                    x += rdim[2] / jC;
                }// if close
 ...
 **/
    ...
    API.drawPaymentVendorChallanColumns = function(i, rdim) {
        ...
        /**
         * This section of code to generate Rectangle box on PDF 
         * 
         * */
...
function printPaymentChallanOnPDF(order_id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            /* THESE VARIABLES ARE ADDED BY VARUN */
                shop_logo_image = jsonData['shop_logo_image'];
                alert(shop_logo_image);
                //alert(shop_logo_image);
                shop_logo_height = jsonData['shop_logo_height'];
                shop_logo_width = jsonData['shop_logo_width'];
            ...
            generatePDF_payment_challan(barcode_height, barcode_width, barcode_image, logged_inuser, order_id, ship_address, bill_address, bphone, sphone, dod, dtype, cs_instruct, goodsData, subtotal, shop_name, shop_logo_image, shop_logo_width, shop_logo_height);
        },
...
function generatePDF_payment_challan(barcode_height, barcode_width, barcode_image, logged_inuser, order_id, ship_address, bill_address, bphone, sphone, dod, dtype, cs_instruct, goodsData, subtotal, shop_name, shop_logo_image, shop_logo_width, shop_logo_height) {
    ...
    pdfdoc.addImage(shop_logo_image, 'JPEG', 75, 3, shop_logo_width, shop_logo_height);
    ...
    // added new
    pdfdoc.text(pdfMinX + 5, titleMaxHeight - 3, shop_name);

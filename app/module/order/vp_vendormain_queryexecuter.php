	...
	if(mysql_num_rows($result) != 0)
	{
		...
		while($row = mysql_fetch_assoc($result))
		{
			...
			while($row2 = mysql_fetch_assoc($result2))
			{
				...
				$temp_order_by_vendor_id = $row2['shop_id_created'];
				$temp_order_by_vendor_name = $associated_vendors_array[$temp_order_by_vendor_id]['name'];
...
/*
				...
				{
					$temp_vendor_name = $vendors_array[$temp_vendor_id];
				}
*/
				...
				$orders_details_array[$orderid_inside_while_loop]['vendor_name'] = $temp_order_by_vendor_name;
			}
		}
	}
	else
...
if($orders_flag == 1)
{
	...
	{
		echo "<tr class='table_data_row_myorders' id='tr_$row_counter'>";
		...
		echo "
			...
			*/
			...
			echo "<td class='form_click' id='orderid_vendor_$row_counter' style='width:11%; $style'><u>$display_label</u><br><br>From : ".$orders_details_array[$orders_details_array_inside_foreach]['vendor_name']."</td>";

...
if($orders_flag == 1)
{
	...
	foreach($orders_details_array_keys as $orders_details_array_inside_foreach)
	{
		...
		echo "
			...
			echo "<td class='form_click' id='orderid_vendor_$row_counter' style='width:11%; $style'>".$orders_details_array[$orders_details_array_inside_foreach]['vendor_name']."<br>$display_label</td>";

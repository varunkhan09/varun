<?php
	...
	//var_dump($associated_vendors_array);
?>
<html>
<head>
...
-->
	<script>
		//$(document).ready(function(){
			//query = "select distinct orderid from panelorderdetails where (vendor_id is NULL or vendor_id='') and shop_id_created=<?php echo $shop_id; ?> OR shop_id_by=<?php echo $shop_id; ?>";
		...
		$(document).ready(function(){
			$(document).on('click', '#filter_form_button', function(){
				...
				if(orderid == "")
				{
					...
					{
						query = "select distinct orderid from panelorderdetails where 1=1 and shop_id_created=<?php echo $shop_id; ?>";
						if(delivery_date != "")
						{
						...
						if(order_status != "4")
						{
							query = "select distinct orderid from vendor_processing where state="+order_status+" and orderid in ("+query+") and shop_id_created=<?php echo $shop_id; ?>";
						}
				...
				{
					query = "select distinct orderid from panelorderdetails where orderid="+orderid+" and shop_id_created=<?php echo $shop_id; ?>";

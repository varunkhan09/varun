...
else
{
	if($_REQUEST['flag'] == "1")
	{
		...
		$query = "select * from panelorderdetails where orderid=".$_REQUEST['orderid']." and shop_id_created = $shop_id";
		...
		if(mysql_num_rows($result)>0)
		{
			...
			*/
			...
			$vendor_grand_total = $vendor_product_total+$order_information['shipping_charges'];
?>
			<div class='first_div'>

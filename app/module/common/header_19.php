            ...
            <div id="nav" class="row dashboard_div">
                <ul id="navigation" class="col-xs-12 nav navbar-nav">
                    <li style="background:#009ACD;" class="header_flaberry_icon_li">
                        <img src="<?php echo $base_media_image_url; ?>/flaberry.png" style="width:200px; height:48px; margin:1em 2em 1em 1.5em; background:#009ACD;" id="flaberry_icon_clicked">
                    </li>
            ...
            <div class="container-fluid header_main_container2">
                ...
                <div class="row" style="background:#DCDCDC;height:30px;padding:5px;margin-top:-20px;">
                    <div class="col-xs-2 col-xs-offset-1 order_status_links">
                        <a href="<?php echo $to_be_assigned; ?>" class="blue_links subhhead">To Be Assigned</a>
                    </div>

                    <div class="col-xs-2 text-center order_status_links">
                        <a href="<?php echo $awaiting_delivery_pickup; ?>" class="blue_links subhhead">Awaiting Delivery/Pickup</a>
                    </div>

                    <div class="col-xs-2 text-center order_status_links">
                        <a href="<?php echo $oh_hold; ?>" class="blue_links subhhead">On Hold</a>
                    </div>

                    <div class="col-xs-2 text-center order_status_links">
                        <a href="<?php echo $out_for_delivery; ?>" class="blue_links subhhead">Out for Delivery</a>
                    </div>

                    <div class="col-xs-2 text-center">
                        <a href="<?php echo $order_sent_out; ?>" class="blue_links subhhead">Orders Sent Out </a>
                    </div>
                </div>
            </div>

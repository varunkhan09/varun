...
myshop.controller('ShopAddByUserCtrl',function($scope,$routeParams,ShopService,$log,$location,ROOT) {
...
myshop.controller('ShopInfoEditCtrl',function($routeParams,$scope,$log,$location,ShopService,ROOT) {
console.log($routeParams);

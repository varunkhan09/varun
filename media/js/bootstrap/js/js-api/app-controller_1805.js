...
myshop.controller('ShopAddByUserCtrl',function($scope,$routeParams,ShopService,$log) {
...
myshop.controller('ShopInfoEditCtrl',function($routeParams,$scope,$log,$location,ShopService) {
...
// if normal parameter like http://www.domain.com/shop?shop_id = 13
var searchData = {};
searchData = $location.search();

if(searchData.hasOwnProperty('shop_id')){
    if( typeof searchData.shop_id === 'string'){
        $scope.edit_shop_id = parseInt(searchData.shop_id,10);
         ...
         ShopService.updateShop($scope.Shop).then(function(response){             
                if(response.status === 200){
                  ...
                  alert('Successfully submitted.');
                   // toggle action end
                    // $scope.alerts = [
                    //     {type: 'success' , msg: "Successfully submitted.",msgtag : 'Well done! '}
                    // ];
                }else{
                  alert('Provide input and try it again.');
                    // $scope.alerts = [
                    //     {type: 'warning' , msg: "Provide input and try it again.",msgtag : 'Warning! '}
                    // ];
                }
            });
  }
...
myshop.controller('EmployeeEditCtrl',function($scope,$routeParams,$location,$log,EmpService) {
    ...
    // if(searchData.hasOwnProperty('emp_uid')){
    //     var emp_entity_id =  searchData.emp_uid;
    //     loadEmployeeInfo(emp_entity_id);
    // }

...
myshop.config(['$routeProvider',function($routeProvider) {
    $routeProvider.
      ...
      when('/user/:user_id/shop/:shop_id/dcharge', {
       ...
       when('/user/:user_id/shop/:shop_id/edit-dcharge', {
        templateUrl: "dzone/edit-dcharge.php",
        controller: "DeliveryChargeEditCtrl"
      }).

      when('/user/:user_id/shop/:shop_id/update-dcharge', {
        templateUrl: "dzone/update-dcharge.php",
        controller: "DeliveryChargeUpdateCtrl"
      }).

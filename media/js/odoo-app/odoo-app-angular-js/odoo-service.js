...
odooApp.constant('ROOT', (function() {
    var resource = 'http://myfloralstore.com:8882';
    return {
        DOMAIN: resource
    }
})());
...
odooApp.service('vModelService', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('Vehicles', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('AdditionalService',function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('Odometer', function($http,ROOT) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('Model', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('VCost', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('VFuel', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('VService', function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('vehiclesStatService',function(ROOT,$http) {
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?';
...
odooApp.service('Report', function(ROOT,$http) {  
        var serviceBase = ROOT.DOMAIN+'/app/module/odoo-app/server/api.php/q?'; 
